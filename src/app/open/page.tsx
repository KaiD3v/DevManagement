...
export default function OpenTicket() {
  ...
  return (
    <div className="w-full max-w-2xl mx-auto px-2">
      ...
      <main className="flex flex-col my-4 mb-2">
        {customer ? (
          <div className="bg-slate-200 py-6 px-4 rounded border-2 flex items-center justify-between">
            ...
            <button className="bg-red-600 h-11 px-2 flex items-center justify-center rounded">
              <FiX onClick={handleClearCustomer} size={24} color="#FFF" />
            </button>
          </div>
        ) : (
          <form
